        ...
        <div id='projeto-card'>
            <div id='quadro-projeto' style='background:${projeto.detalhesDoProjeto.cor}'>
                <div id='projeto-codigo'>
                    <div class='botoes'>
                        <img class='ellipses' src='src/assets/imagens/ellipse-3.svg'>
                        <img class='ellipses' src='src/assets/imagens/ellipse-2.svg'>
                        <img class='ellipses' src='src/assets/imagens/ellipse-1.svg'>
                    </div>
                <div id='text-editor'>
